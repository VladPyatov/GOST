...
CURVES = {
    "GostR3410_2001_ParamSet_cc": Curve(
    ...
    "id-GostR3410-2001-TestParamSet": Curve(
    ...
    "id-tc26-gost-3410-12-256-paramSetA": Curve(
    ...
    "id-tc26-gost-3410-12-256-paramSetB": Curve(
        p=bytes2long(hexdec("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFD97")),
    ...
    "id-tc26-gost-3410-12-256-paramSetC": Curve(
    ...
    "id-tc26-gost-3410-12-256-paramSetD": Curve(
    ...
    "id-tc26-gost-3410-12-512-paramSetTest": Curve(
    ...
    "id-tc26-gost-3410-12-512-paramSetA": Curve(
    ...
    "id-tc26-gost-3410-12-512-paramSetB": Curve(
    ...
    "id-tc26-gost-3410-12-512-paramSetC": Curve(
        p=bytes2long(hexdec("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFDC7")),
...
def verify(curve, pub, digest, signature):
    ...
    z1 = s * v % q
    z2 = q - r * v % q
    p1x, p1y = curve.summator(z1)
    q1x, q1y = curve.summator(z2, pub[0], pub[1])
    lm = q1x - p1x
    if lm < 0:
        lm += p
    lm = modinvert(lm, p)
